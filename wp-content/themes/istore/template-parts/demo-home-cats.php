<?php
$first_img = get_theme_mod('istore_front_page_demo_banner_img', get_template_directory_uri() . '/template-parts/demo-img/demo-image-top.jpg');
$first_img_title = get_theme_mod('istore_front_page_demo_banner_title', __('MaxStore', 'maxstore'));
$first_img_desc = get_theme_mod('istore_front_page_demo_banner_desc', __('Edit this section in customizer', 'maxstore'));
$first_img_button = __('View More', 'maxstore');
$first_img_button_url = get_theme_mod('istore_front_page_demo_banner_url', '#');
