...
Kirki::add_field( 'di_multipurpose_config', array(
	...
	'output' => array(
		array(
			'element'  => '.masterbtn:hover, .masterbtn:focus',
			'property' => 'background-color',
		),
		array(
			'element'  => '.wpcf7-form .wpcf7-form-control.wpcf7-submit:hover, .wpcf7-form .wpcf7-form-control.wpcf7-submit:focus',
			'property' => 'background-color',
		),
		array(
			'element'  => '.woocommerce #respond input#submit:hover, .woocommerce a.button:hover, .woocommerce button.button:hover, .woocommerce input.button:hover, .woocommerce #respond input#submit:focus, .woocommerce a.button:focus, .woocommerce button.button:focus, .woocommerce input.button:focus',
			'property' => 'background-color',
			'suffix'	=> '!important',
		),
		array(
			'element'  => '.woocommerce #respond input#submit.alt:hover, .woocommerce a.button.alt:hover, .woocommerce button.button.alt:hover, .woocommerce input.button.alt:hover, .woocommerce #respond input#submit.alt:focus, .woocommerce a.button.alt:focus, .woocommerce button.button.alt:focus, .woocommerce input.button.alt:focus',
			'property' => 'background-color',
			'suffix'	=> '!important',
		),
		array(
		...
		array(
			'element'  => '.tagcloud a:hover, .tagcloud a:focus',
			'property' => 'background-color',
		),
		array(
			'element'  => '.tagcloud a:hover::before, .tagcloud a:focus::before',
			'property' => 'border-right-color',
		),
		array(
			'element'  => '.singletags a:hover, .singletags a:focus',
			'property' => 'background-color',
		),
		array(
			'element'  => '.singletags a:hover::before, .singletags a:focus::before',
			'property' => 'border-right-color',
		),
		array(
			'element'  => '#back-to-top:hover, .di_multipurpose_social_widget a:hover, .bbp-submit-wrapper .button:hover, #back-to-top:focus, .di_multipurpose_social_widget a:focus, .bbp-submit-wrapper .button:focus',
			'property' => 'background-color',
		),
		array(
			'element'  => '.side-menu-menu-button:hover, .side-menu-menu-button:focus',
			'property' => 'background-color',
		),
		array(
		...
		array(
			'element'  => '.woocommerce.widget_product_search button[type="submit"]:hover, .woocommerce.widget_product_search button[type="submit"]:focus',
			'property' => 'background-color',
		),
		array(
		...
		array(
			'element'  => '.yikes-mailchimp-container .yikes-easy-mc-submit-button.btn-primary:hover, .yikes-mailchimp-container .yikes-easy-mc-submit-button.btn-primary:focus',
			'property' => 'background-color',
		),
		array(
			'element'  => '#bbpress-forums #bbp-search-form #bbp_search_submit:hover, .maincontainer .container .left-content  .content-third .entry-content a.subscription-toggle:hover, #bbpress-forums div.bbp-topic-tags a:hover, .widget_display_search #bbp-search-form #bbp_search_submit:hover, #bbpress-forums #bbp-search-form #bbp_search_submit:focus, .maincontainer .container .left-content  .content-third .entry-content a.subscription-toggle:focus, #bbpress-forums div.bbp-topic-tags a:focus, .widget_display_search #bbp-search-form #bbp_search_submit:focus',
			'property' => 'background-color',
		),
	),
	'transport' => 'auto',
